...
hparams = tf.contrib.training.HParams(
    ...
    # Side of the window. Current step does not count. If mode is window and attention_win_size is not pair, the 1 extra is provided to forward part of the window.
